...
CEKEXPIRED () {
    ...
    Exp1=$(curl -sS https://raw.githubusercontent.com/arlanstore4/supreme/main/permission/ip| grep $MYIP | awk '{print $3}')
    if [[ $today < $Exp1 ]]; then
...
IZIN=$(curl -sS https://raw.githubusercontent.com/arlanstore4arlanstore4/supreme/main/permission/ip| awk '{print $4}' | grep $MYIP)
if [ $MYIP = $IZIN ]; then
